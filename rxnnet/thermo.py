...
class Thermochemistry:
    ...
    rigid-rotor (nonlinear) and ideal-gas translations."""
    ...
    def _qrrho_vib_entropy_JmolK(
        ...
        for nu in freqs_cm:
            ...
            S_fr = R * (0.5 + 0.5 * math.log(8.0 * math.pi**3 * mu_eff * kB * T / h**2))
    ...
    def trans_entropy(T: float, mass_amu: float, p_Pa: float, c_M: float) -> float:
        ...
        S = R [ ln( (2π m kT / h^2)^(3/2) * (kT/p) ) + 5/2 ]
        """
