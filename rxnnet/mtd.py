...
from rxnnet.chemutils import ac2mol, read_multi_xyz
from rxnnet.utils import WorkingDir, check_executable
from rxnnet.xtb import set_threads, write_xyz, xtb_calculate
...
def md_step(
    ...
    # read log file
    if result:
        with open((xyz_file.parent / "xtb.out").absolute(), "r") as f:
            result["log"] = f.read()
